...
sub recv_line_stderr {
	my $self = shift;
	my ($str, $timeout, $closed) = _recv_line_timed($self->{ptyerr}->master(), 3);
...
sub recv_line_stdout {
	my $self = shift;
	my ($str, $timeout, $closed) = _recv_line_timed($self->{ptyinout}->master(), 3);
...
# Tests \E0 rajouter
# Serveur local
# 	Envoie des premi\E8res lignes d\E9coup\E9 (avec petite pause)
# 	Envoie de plusieurs lignes \E0 la fois
# 	cd r\E9pertoire super large -> erreur
# 	t\E9l\E9chargement nom fichier super large -> erreur
# 	T\E9l\E9chargement sur une addresse ip diff\E9rente
# 	Authentification
# 	Port diff\E9rent
# 	debug ?
...
sub test2 {
	print "\n\n[TEST2] Connexion, cd1, d\E9connexion\n";
	my $client = new ClientTester($ARGV[0], '-h', 'ftp.univ-lyon1.fr');
	$client->start_slurp_stdout();
	return 0 if (!$client->checked_expect_err_line_now("OK: Bienvenue"));
	return 0 if (!$client->checked_expect_err_line_now("OK: Please specify"));
...
sub test3 {
	print "\n\n[TEST3] Connexion, cd2, d\E9connexion\n";
	my $client = new ClientTester($ARGV[0], '-h', 'ftp.univ-lyon1.fr');
	$client->start_slurp_stdout();
	return 0 if (!$client->checked_expect_err_line_now("OK: Bienvenue"));
	return 0 if (!$client->checked_expect_err_line_now("OK: Please specify"));
...
sub test4 {
	print "\n\n[TEST4] Connexion, cd0, d\E9connexion\n";
	my $client = new ClientTester($ARGV[0], '-h', 'ftp.univ-lyon1.fr');
	$client->start_slurp_stdout();
	return 0 if (!$client->checked_expect_err_line_now("OK: Bienvenue"));
	return 0 if (!$client->checked_expect_err_line_now("OK: Please specify"));
...
sub test5 {
	print "\n\n[TEST5] Connexion, ls, d\E9connexion\n";
	my $client = new ClientTester($ARGV[0], '-h', 'ftp.univ-lyon1.fr');
	return 0 if (!$client->checked_expect_err_line_now("OK: Bienvenue"));
	return 0 if (!$client->checked_expect_err_line_now("OK: Please specify"));
	return 0 if (!$client->checked_expect_err_line_now("OK: Login successful"));
...
sub test6 {
	print "\n\n[TEST6] Connexion, ls1, d\E9connexion\n";
	my $client = new ClientTester($ARGV[0], '-h', 'ftp.univ-lyon1.fr');
	return 0 if (!$client->checked_expect_err_line_now("OK: Bienvenue"));
	return 0 if (!$client->checked_expect_err_line_now("OK: Please specify"));
	return 0 if (!$client->checked_expect_err_line_now("OK: Login successful"));
...
sub test7 {
	print "\n\n[TEST7] Connexion, cd, ls1, d\E9connexion\n";
	my $client = new ClientTester($ARGV[0], '-h', 'ftp.univ-lyon1.fr');
	return 0 if (!$client->checked_expect_err_line_now("OK: Bienvenue"));
	return 0 if (!$client->checked_expect_err_line_now("OK: Please specify"));
	return 0 if (!$client->checked_expect_err_line_now("OK: Login successful"));
...
sub test8 {
	print "\n\n[TEST8] Connexion, cd2, t\E9l\E9chargement, d\E9connexion\n";
	my $client = new ClientTester($ARGV[0], '-h', 'ftp.univ-lyon1.fr');
	$client->start_slurp_stdout();
	return 0 if (!$client->checked_expect_err_line_now("OK: Bienvenue"));
	return 0 if (!$client->checked_expect_err_line_now("OK: Please specify"));
...
sub test9 {
	print "\n\n[TEST9] Connexion, t\E9l\E9chargement2, d\E9connexion\n";
	my $client = new ClientTester($ARGV[0], '-h', 'ftp.univ-lyon1.fr');
	$client->start_slurp_stdout();
	return 0 if (!$client->checked_expect_err_line_now("OK: Bienvenue"));
	return 0 if (!$client->checked_expect_err_line_now("OK: Please specify"));
...
sub test10 {
	print "\n\n[TEST10] Connexion, t\E9l\E9chargement3, d\E9connexion\n";
	my $client = new ClientTester($ARGV[0], '-h', 'ftp.univ-lyon1.fr');
	$client->start_slurp_stdout();
	return 0 if (!$client->checked_expect_err_line_now("OK: Bienvenue"));
	return 0 if (!$client->checked_expect_err_line_now("OK: Please specify"));
...
sub test11 {
	print "\n\n[TEST11] Connexion, cd0, t\E9l\E9chargement, d\E9connexion\n";
	my $client = new ClientTester($ARGV[0], '-h', 'ftp.univ-lyon1.fr');
	$client->start_slurp_stdout();
	return 0 if (!$client->checked_expect_err_line_now("OK: Bienvenue"));
	return 0 if (!$client->checked_expect_err_line_now("OK: Please specify"));
...
sub test12 {
	print "\n\n[TEST12] Connexion, cd0, cd2, t\E9l\E9chargement0, t\E9l\E9chargement, d\E9connexion\n";
	my $client = new ClientTester($ARGV[0], '-h', 'ftp.univ-lyon1.fr');
	$client->start_slurp_stdout();
	return 0 if (!$client->checked_expect_err_line_now("OK: Bienvenue"));
	return 0 if (!$client->checked_expect_err_line_now("OK: Please specify"));
...
sub test13 {
	print "\n\n[TEST13] fichier: connexion, d\E9connexion\n";
...
sub test14 {
	print "\n\n[TEST14] fichier: Connexion, cd1, d\E9connexion\n";
	open (my $ftpcmds, ">", "commands.ftp") or die("open(commands.ftp): $!");
...
sub test15 {
	print "\n\n[TEST15] fichier: Connexion, cd2, d\E9connexion\n";
	open (my $ftpcmds, ">", "commands.ftp") or die("open(commands.ftp): $!");
...
sub test16 {
	print "\n\n[TEST16] fichier: Connexion, cd0, d\E9connexion\n";
	open (my $ftpcmds, ">", "commands.ftp") or die("open(commands.ftp): $!");
...
sub test17 {
	print "\n\n[TEST17] fichier: Connexion, ls, d\E9connexion\n";
	open (my $ftpcmds, ">", "commands.ftp") or die("open(commands.ftp): $!");
...
sub test18 {
	print "\n\n[TEST18] fichier: Connexion, ls1, d\E9connexion\n";
	open (my $ftpcmds, ">", "commands.ftp") or die("open(commands.ftp): $!");
...
sub test19 {
	print "\n\n[TEST19] fichier: Connexion, cd, ls1, d\E9connexion\n";
	open (my $ftpcmds, ">", "commands.ftp") or die("open(commands.ftp): $!");
	print $ftpcmds "repertoire pub\n";
...
sub test20 {
	print "\n\n[TEST20] fichier: Connexion, cd2, t\E9l\E9chargement, d\E9connexion\n";
	open (my $ftpcmds, ">", "commands.ftp") or die("open(commands.ftp): $!");
	print $ftpcmds "repertoire pub/vpn\n";
...
sub test21 {
	print "\n\n[TEST21] fichier: Connexion, t\E9l\E9chargement2, d\E9connexion\n";
	open (my $ftpcmds, ">", "commands.ftp") or die("open(commands.ftp): $!");
...
sub test22 {
	print "\n\n[TEST22] fichier: Connexion, t\E9l\E9chargement3, d\E9connexion\n";
	open (my $ftpcmds, ">", "commands.ftp") or die("open(commands.ftp): $!");
...
sub test23 {
	print "\n\n[TEST23] fichier: Connexion, cd0, t\E9l\E9chargement, d\E9connexion\n";
	open (my $ftpcmds, ">", "commands.ftp") or die("open(commands.ftp): $!");
	print $ftpcmds "repertoire inexistent\n";
	print $ftpcmds "recuperer /pub/vpn/conseils.txt\n";
	print $ftpcmds "deconnecte\n";
...
sub test24 {
	print "\n\n[TEST24] fichier: Connexion, cd0, cd2, t\E9l\E9chargement0, t\E9l\E9chargement, d\E9connexion\n";
	open (my $ftpcmds, ">", "commands.ftp") or die("open(commands.ftp): $!");
	print $ftpcmds "repertoire inexistent\n";
	print $ftpcmds "repertoire pub/vpn\n";
	print $ftpcmds "recuperer /fichier/inexistant.txt\n";
...
sub test25 {
	print "\n\n[TEST25] Connexion, cd+cd, t\E9l\E9chargement, d\E9connexion\n";
	my $client = new ClientTester($ARGV[0], '-h', 'ftp.univ-lyon1.fr');
	$client->start_slurp_stdout();
	return 0 if (!$client->checked_expect_err_line_now("OK: Bienvenue"));
	return 0 if (!$client->checked_expect_err_line_now("OK: Please specify"));
...
sub test26 {
	print "\n\n[TEST26] fichier: Connexion, cd long, d\E9connexion\n";
	open (my $ftpcmds, ">", "commands.ftp") or die("open(commands.ftp): $!");
...
sub main {
	...
	print "$numsuccess tests r\E9ussis, $numfail \E9chou\E9s\n";
}
